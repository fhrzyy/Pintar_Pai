...
@section('content')
    <div class="bg-white rounded-lg shadow-md">
        ...
        <div class="p-6">
            ...
            <p class="mb-2"><span class="font-bold">Jawaban Anda:</span> {{ $userAnswer }}</p>
            <p class="mb-4"><span class="font-bold">Jawaban Benar:</span> {{ $question->correct_answer }}</p>
            @if ($isCorrect)
            ...
            @endif
            <a href="{{ route('user.questions.index', $question->material_id) }}" 
