    ...
    @section('content')
        <div class="max-w-7xl mx-auto">
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                <div class="px-6 py-5 bg-gradient-to-r from-indigo-600 to-purple-700 text-white p-6 border-b border-gray-100 flex items-center">
                    ...
                    <h3 class="text-xl font-bold text-white">Pilih Materi untuk Mengerjakan Soal</h3>
                </div>
                                ...
                                <div class="bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-1">
                                    <div class="p-6">
                                        <div class="text-center">
                                            ...
                                            class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-700 hover:from-indigo-700 hover:to-purple-800 text-white rounded-lg transition-colors duration-200">
